# 1 "e:\\test\\loadrunnertest\\demo3\\\\combined_demo3.c"
# 1 "globals.h" 1
...
# 1 "e:\\test\\loadrunnertest\\demo3\\\\combined_demo3.c" 2
...
# 3 "e:\\test\\loadrunnertest\\demo3\\\\combined_demo3.c" 2
...
# 4 "e:\\test\\loadrunnertest\\demo3\\\\combined_demo3.c" 2
...
{ 
    ...
    lr_output_message("Result:%s",lr_eval_string("{result}")); 
    if(strstr(lr_eval_string("{result}"),"ºÏ·Ê")>0){ 
        lr_end_transaction("send",0); 
    }else{ 
        lr_end_transaction("send",2); 
    } 
    return 0; 
} 
# 5 "e:\\test\\loadrunnertest\\demo3\\\\combined_demo3.c" 2
...
# 6 "e:\\test\\loadrunnertest\\demo3\\\\combined_demo3.c" 2
